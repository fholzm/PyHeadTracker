...
def test_quat2ypr(quat, ypr):
    ...
    assert pytest.approx(ypr[0], rel=1e-2) == ypr_converted[0]
    assert pytest.approx(ypr[1], rel=1e-2) == ypr_converted[1]
    assert pytest.approx(ypr[2], rel=1e-2) == ypr_converted[2]
